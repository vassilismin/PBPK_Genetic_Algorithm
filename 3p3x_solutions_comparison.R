...
A2 <- create_ODE_matrix(phys_pars = phys_pars, fit_pars = params2,  position = position2)
A3 <- create_ODE_matrix(phys_pars = phys_pars, fit_pars = params3,  position = position3)
A4 <- create_ODE_matrix(phys_pars = phys_pars, fit_pars = params4,  position = position4)
A5 <- create_ODE_matrix(phys_pars = phys_pars, fit_pars = params5,  position = position5)
...
# Solve the ODE system using the exponential matrix method  
solution1 <-  as.data.frame(solve_exp_matrix(x = A1, time = sample_time, 
                                                y_init = y_init,phys_pars = phys_pars ))
names(solution1) <- c("Time", "Blood", "Heart", "Lungs", "Liver",  "Spleen",
                         "Kidneys","Git", "Bone",  "Feces", "Urine")

solution2 <-  as.data.frame(solve_exp_matrix(x = A2, time = sample_time, 
                                             y_init = y_init,phys_pars = phys_pars ))
names(solution2) <- c("Time", "Blood", "Heart", "Lungs", "Liver",  "Spleen",
                      "Kidneys","Git", "Bone",  "Feces", "Urine")

solution3 <-  as.data.frame(solve_exp_matrix(x = A3, time = sample_time, 
                                             y_init = y_init,phys_pars = phys_pars ))
names(solution3) <- c("Time", "Blood", "Heart", "Lungs", "Liver",  "Spleen",
                      "Kidneys","Git", "Bone",  "Feces", "Urine")

solution4 <-  as.data.frame(solve_exp_matrix(x = A4, time = sample_time, 
                                             y_init = y_init,phys_pars = phys_pars ))
names(solution4) <- c("Time", "Blood", "Heart", "Lungs", "Liver",  "Spleen",
                      "Kidneys","Git", "Bone",  "Feces", "Urine")

solution5 <-  as.data.frame(solve_exp_matrix(x = A5, time = sample_time, 
                                             y_init = y_init,phys_pars = phys_pars ))
names(solution5) <- c("Time", "Blood", "Heart", "Lungs", "Liver",  "Spleen",
                      "Kidneys","Git", "Bone",  "Feces", "Urine")
...
metric.print(solution1)
print("Next")
metric.print(solution2)
print("Next")
metric.print(solution3)
print("Next")
metric.print(solution4)
print("Next")
metric.print(solution5)
